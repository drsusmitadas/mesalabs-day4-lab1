...
If you were unable to complete the run or would like to verify your history.data output file, you may grab the pre-computed output history files corrspondingto your chosen mass from [here](static/thursday/Computed_History_Files)
